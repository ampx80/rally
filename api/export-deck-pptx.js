...
export default withErrorHandling(async (req, res) => {
  ...
  pptx.defineLayout({ name: 'ARDOVO', width: 13.333, height: 7.5 });
  pptx.layout = 'ARDOVO';
  pptx.author = 'Ardovo';
  pptx.company = 'Ardovo';
  ...
  s1.addText('ARDOVO', { x: 0.6, y: 0.5, w: 4, h: 0.4, color: INDIGO, fontSize: 14, bold: true, charSpacing: 3 });
  ...
  s5.addText('Generated by Ardovo - run your revenue on Ardovo.', { x: 0.6, y: 6.9, w: 12, h: 0.4, color: '8B93A4', fontSize: 11 });
