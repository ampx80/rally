...
//
// Optional owner notification when a Ardovo hosted form (/f/:formId) is
...
export default withErrorHandling(async (req, res) => {
  ...
  const bodyHtml = `
    ...
    <p style="font-size:15px;color:#a3a7ba;margin:0 0 20px;">A new lead just came through your Ardovo form. It has already been created as a contact in your pipeline.</p>
  ...
  const result = await sendEmail({
    to,
    subject: `New Ardovo form submission: ${formName}`,
    bodyHtml,
    eyebrow: 'Ardovo forms',
