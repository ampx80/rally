...
export const TYPE_META = {
  ...
  usecase:     { category: 'Use cases',    group: 'Solutions', icon: 'target',  blurb: 'How teams put Ardovo to work for a specific job.' },
  ...
  integration: { category: 'Integrations', group: 'Solutions', icon: 'plug',    blurb: 'Connect Ardovo to the tools you already run on.' },
  comparison:  { category: 'Ardovo vs',     group: 'Compare',  icon: 'command',  blurb: 'How Ardovo stacks up against the incumbents.' },
