...
const entry = {
  ...
  metaTitle: 'CRM Migration Guide (2026): Phases, Checklist, Cutover, and a Downtime Calculator | Rally',
  ...
  blocks: [
    ...
    },
    {
      ...
      columns: ['Rally', 'Legacy CRM', 'Spreadsheet'],
      highlightCol: 0,
      rows: [
