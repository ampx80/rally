...
const entry = {
  ...
  metaTitle: 'CRM vs Marketing Automation: What Is the Difference? (2026 Explainer) | Rally',
  ...
  blocks: [
    ...
    },
    {
      ...
      columns: ['Rally (one platform)', 'CRM only', 'Marketing automation only'],
      highlightCol: 0,
      rows: [
