...
const entry = {
  ...
  metaTitle: 'Lead Scoring: The Complete Guide (Fit, Intent, and AI Models) | Rally',
  ...
  blocks: [
    ...
    },
    {
      ...
      body: [
        ...
        'The best systems in 2026 are hybrid. They start rule-based so you get value immediately, layer predictive learning on top as data accumulates, and keep the reasoning visible so a rep can see why a lead scored the way it did. Rally is built this way: Rook, the AI operator, scores and ranks leads the moment they arrive using sensible defaults, then sharpens against your real outcomes, and always shows its work.',
      ],
    },
    {
      ...
      rowHeader: 'Attribute',
      columns: ['Rally hybrid', 'Rule-based', 'Pure AI'],
      highlightCol: 0,
      rows: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'How quickly should a high-scoring lead be contacted?', a: 'As fast as possible. Contact and qualification rates are dramatically higher when a lead is worked within about five minutes of arriving versus even thirty. That is the entire reason to automate routing: a hot lead that waits in a queue for hours loses much of the intent that made it hot. Rally routes and alerts on high-score leads within seconds so the window is never missed.' },
      ],
    },
  ],
