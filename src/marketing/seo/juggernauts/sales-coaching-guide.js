...
const entry = {
  ...
  metaTitle: 'Sales Coaching: The Complete Guide (Cadence, Skills, ROI Calculator) | Ardovo',
  ...
  blocks: [
    ...
    },
    {
      ...
      body: [
        ...
        'Ardovo is built AI-native, alive on first load, at one flat price. Its operator, Rook, watches the signal you would otherwise miss: it flags stalling deals, scores risk, surfaces where a rep skipped a buyer, and drafts the prep so your coaching time goes to the conversation, not the spreadsheet. The point is not to replace the manager. It is to hand the manager the visibility that makes real coaching possible.',
        'You do not need Ardovo to run this cadence, and this guide is useful no matter what you use. But if your coaching keeps drowning in status because the pipeline is opaque, the fix is a CRM that shows you what to coach.',
      ],
    },
    {
      type: 'faq',
