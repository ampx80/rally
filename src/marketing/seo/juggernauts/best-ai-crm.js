...
const entry = {
  ...
  metaTitle: 'The Best AI CRM in 2026: Buyer Guide, Comparison, and Selection Criteria | Rally',
  ...
  intro: [
    ...
    'This guide defines what a real AI CRM is, gives you the criteria to separate genuine AI-native platforms from retrofits, and shows the architecture that makes the difference. Use it to evaluate any vendor, not just Rally.',
  ],
  heroStats: [
  ...
  blocks: [
    ...
    },
    {
      ...
      columns: ['AI-native (Rally)', 'AI-assisted', 'AI-washed'],
      highlightCol: 0,
      rows: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'What is the best AI CRM?', a: 'The best one is AI-native by the three tests in this guide: it executes work, runs on one source of truth, and is fully governed. Rally is built around an AI operator, Rook, that meets all three.' },
      ],
    },
  ],
