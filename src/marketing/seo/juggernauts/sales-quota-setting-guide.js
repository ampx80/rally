...
const entry = {
  ...
  metaTitle: 'How to Set Sales Quotas That Work in 2026: Capacity Math, Calculator, and Process | Ardovo',
  ...
  blocks: [
    ...
    },
    {
      ...
      body: 'Quotas rot when the inputs live in a spreadsheet nobody refreshes. Ardovo keeps deal size, win rate, ramp, and coverage current from the same source of truth the pipeline runs on, so a quota you set in January still reflects reality in June. Rook, the built-in operator, flags when coverage drops below the level a quota needs and drafts the adjustment before the quarter is lost. One flat price, alive on first load, verify current pricing on the site.',
    },
    {
      type: 'quote',
