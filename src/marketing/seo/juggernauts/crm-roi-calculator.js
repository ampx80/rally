...
const entry = {
  ...
  metaTitle: 'Free CRM ROI Calculator (2026): Model Your Return in Seconds | Ardovo',
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'What CRM should I use to capture this ROI?', a: 'Any system your team actually updates. Ardovo is built to be alive on first load and to have an AI operator do the follow-up work, which is exactly what drives the lift this calculator models.' },
      ],
    },
  ],
