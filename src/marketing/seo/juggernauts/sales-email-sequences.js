...
const entry = {
  ...
  metaTitle: 'Sales Email Sequences That Convert in 2026: Cadence, Reply Math, and Templates | Ardovo',
  ...
  blocks: [
    ...
    },
    {
      ...
      columns: ['Ardovo', 'Standalone sequencer', 'Manual + spreadsheet'],
      highlightCol: 0,
      rows: [
